...
class Comment {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ARIPD\UserBundle\Entity\User", inversedBy="cmspostcomments")
	...
	/**
	 * @ORM\ManyToOne(targetEntity="ARIPD\CMSBundle\Entity\Post", inversedBy="comments")
